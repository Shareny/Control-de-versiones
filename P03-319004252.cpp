...
void CrearPiramideTriangular()
{
	...
	GLfloat vertices_piramide_triangular[] = {
		-0.65f * max, -0.55f * max, 0.0f * max,  
		0.65f * max, -0.55f * max, 0.0f * max,   
		0.0f * max, 0.7f * max, -0.36f * max,   
		-0.1f * max, -0.57f * max, -1.1f * max   
	};
	...
	GLfloat punta_vertices_piramide_triangular[] = {
		-0.7f, -0.7f, 0.0f,  // V�rtice 0
		0.7f, -0.7f, 0.0f,   // V�rtice 1
		0.0f, 0.7f, -0.3f,   // V�rtice 2 Cima
		0.0f, -0.65f, -1.0f   // V�rtice 3 Base de atr�s
	};
...
int main()
{
    ...
    while (!mainWindow.getShouldClose())
    {
        ...
        // Renderizar la base (pir�mide negra)
        ...
        meshList[0]->RenderMesh(); // Renderizar la pir�mide negra
