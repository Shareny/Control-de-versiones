...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//------------- LLANTA 1-----------------
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.9f, -1.7f, -1.0f));
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 0.8f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);                    // rojo
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));   // //para cambiar el color del objetos
		sp.render();
		...
		sp.render();
		shaderList[0].useShader();
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection)); // seguro
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 2.0f, 1.0f)); //Se estableció 5 
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		glUniformMatrix4fv(uniformView, 1, GL_FALSE, glm::value_ptr(camera.calculateViewMatrix()));
		...
		meshList[0]->RenderMesh();
		model = modelaux;
		//------- Articulacion 3 (Brazo izquierdo, cubo pequeño)
		model = glm::translate(model, glm::vec3(-0.4f, 0.3f, 2.0f));
		// TECLA J
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		// Dibujar el cubo pequeño del brazo izquierdo
		...
		model = glm::translate(model, glm::vec3(0.4f, 0.0f, 0.5f)); // Simétrico al brazo izquierdo
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		meshList[0]->RenderMesh();
		model = modelaux;
		//------- Articulacion 5 (Brazo derecho, cubo pequeño)
		model = glm::translate(model, glm::vec3(0.4f, -0.05f, 0.1f));
		// TECLA K
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		// Dibujar el cubo pequeño del brazo derecho
		...
		modelaux = model;
		// Dibujar el cubo pequeño del pie izquierdo
		...
		modelaux = model;
		// Dibujar parte del pie derecho pegada al cuerpo
		model = glm::translate(model, glm::vec3(0.1f, 0.3f, 0.7f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.5f, 1.3f, 0.5f));
		color = glm::vec3(1.0f, 0.6f, 0.3f);
